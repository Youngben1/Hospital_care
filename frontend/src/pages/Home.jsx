  ...
  return (
    <>
            ...
            <div>
              <div className="lg:w-[470px]">
                <h1 className="text-[36px] text-headingColor leading-[46px] font-[800] md:text-[60px] md:leading-[70px] ">
                  We help patients have a healthy, longer and better Sexual
                  Life.
                </h1>
                ...
                <button className="btn sm:items-center">
        ...
        <div className="container">
          <div className="mx-auto lg:w-[470px]">
            <h2 className="heading text-center">
              Providing the best Penile solutions for you
            </h2>
            <p className="text-center text_para">
              He who wants to do anything must do it early before the night
              comes and he is fucked
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px] ">
            <div className="px-5 py-[30px]">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 font-[400] mt-4 text-center text-textColor  ">
                  We provide world class care for everybody and also we have the
                  best health facilities and up to date machines for correcting
                  all issues. From the lab to the clinic.
                </p>

                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] justify-center mx-auto rounded-full border border-solid mt-[30px] hover:border-none border-[#181A1E] group hover:bg-primaryColor items-center flex"
                >
            ...
            <div className="px-5 py-[30px]">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 font-[400] mt-4 text-center text-textColor  ">
                  You can pick from any of our choicest hospitals across the
                  country, epending on your location and the facility closest to
                  you. After confirming your location you can book an
                  Appointment.
                </p>
            ...
            <div className="px-5 py-[30px]">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 font-[400] mt-4 text-center text-textColor  ">
                  After you have found a doctor and selected a location, you can
                  set appointment with the doctor and schedule the perfect day
                  and time to be attended to.
                </p>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                <li className="text_para">1. Schedule a mental appointment.</li>
                <li className="text_para">
                  2. Search for a docki docki and buzz the office.
                </li>
                <li className="text_para">
                  3. See who de accept new patient then try bribe am if e go see
                  you sharpely.
                </li>
              </ul>
              <Link to="/">
              ...
              <div className="absolute bg-white bottom-[50px] left-0 w-[150px] lg:w-[248px] md:bottom-[100px] md:left-5 z-20 p-20 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px] ">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-[6px] lg:gap-3">
                    <p className="text-[10px] leading-[10px]lg:text-[14px] lg:leading-[5px] text-headingColor font-[600]">
                      Tue, 23
                    </p>
                    <p className="text-[10px] leading-[10px]lg:text-[14px] lg:leading-[5px] text-textColor font-[400]">
                      10:30 AM
                    </p>
                  </div>
                  <span className="flex items-center py-1 px-[6px] rounded justify-center w-5 h-5 lg:w-[34px] bg-yellowColor lg:h-[34px] lg:py-3 lg:px-[9px] ">
                    <img src={videoImg} className="cursor-pointer" alt="" />
                  </span>
                </div>

                <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[px] mt-2 lg:mt-4 rounded-full">
                  Consultation
                </div>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            <h2 className="heading text-center">Our Fooking Doctors</h2>
            <p className="text_para text-center">
              Top class care for every patient. Our health care system is
              unmatched
            </p>
